 ...
 */
?><!DOCTYPE html>
<!--[if IEMobile 7]><html class="iem7 ie" <?php print $html_attributes; ?>><![endif]-->
<!--[if lte IE 6]><html class="lt-ie9 lt-ie8 lt-ie7 ie" <?php print $html_attributes; ?>><![endif]-->
<!--[if (IE 7)&(!IEMobile)]><html class="lt-ie9 lt-ie8 ie" <?php print $html_attributes; ?>><![endif]-->
<!--[if IE 8]><html class="lt-ie9 ie" <?php print $html_attributes; ?>><![endif]-->
<!--[if (IE 9)|(gt IEMobile 7)]><html class="ie9 ie" <?php print $html_attributes . $rdf_namespaces; ?>><!--<![endif]-->
